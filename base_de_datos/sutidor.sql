...
CREATE TABLE IF NOT EXISTS `surtidor`.`cliente` (
  ...
  `CL_otronombre` VARCHAR(20) NULL,
  `CL_primerapellido` VARCHAR(20) NOT NULL,
  `CL_segundoapellido` VARCHAR(20) NULL,
...
CREATE TABLE IF NOT EXISTS `surtidor`.`vendedor` (
  ...
  `VE_otronombre` VARCHAR(20) NULL,
  `VE_primerapellido` VARCHAR(20) NOT NULL,
  `VE_segundoapellido` VARCHAR(20) NULL,
  `VE_correo` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `surtidor`.`proveedor` (
  ...
  `PRV_otronombre` VARCHAR(20) NULL,
  `PRV_primerapellido` VARCHAR(20) NOT NULL,
  `PRV_segundoapellido` VARCHAR(20) NULL,
  `PRV_correo` VARCHAR(45) NULL,
