<?php
	...
	*/
	...
	$aColumnas = array('ref', 'nom_art', 'user','cat', 'precio','cant' );
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='modificar_articulo.php?ref=".$aRow['ref']."'><span class='glyphicon glyphicon-pencil'></span></a></td>";
		$row[] = "<td><a href='#' data-href='eliminar_articulo.php?ref=".$aRow['ref']."' data-toggle='modal' data-target='#confirm-delete'><span class='glyphicon glyphicon-trash'></span></a></td>";
