<?php
	...
	*/
	...
	$aColumnas = array('CLWEB_ID' ,'CLWEB_CI', 'CLWEB_correo', 'CLWEB_direccion','CLWEB_telefono', 'CLWEB_primernombre','CLWEB_primerapellido', 'CL_ID', 'CLWEB_inicio' );

	/* columna indexada */
	$sIndexColumn = "CLWEB_CI";
	...
	*/
	...
	while ( $aRow = $rResult->fetch())
	{
		...
		$row[] = "<td><a href='http://elsurtidor.com/admin/articulo/modificacion?referencia=".$aRow['CLWEB_CI']."'><span class='glyphicon glyphicon-pencil'></span></a></td>";
		$row[] = "<td><a href='#' data-href='../settings/sql/delete.php?referencia=".$aRow['CLWEB_CI']."' data-toggle='modal' data-target='#confirm-delete'><span class='glyphicon glyphicon-trash'></span></a></td>";
